;; benchmark_29=2 V0=2 V1=2 V2=2 V3=2 V4=2 V5=2 V6=2 V7=2 V8=2 V9=2 V10=2 V11=2 V12=2 V13=2 V14=2 V16=2 V17=2 V18=2 V19=2 V20=2 V22=2 V23=2 V24=2 V25=2 V26=2 V27=2 V28=2 V29=2 V30=2 V31=2 V32=2 V33=2 V34=2 V36=2 V37=2 V38=2 V39=2 V40=2 V41=2 V42=2 V43=2 V44=2 V46=2 V47=2 V48=2 V49=2 V50=2 V51=2 V52=2 V53=2 V54=2 V55=2 V56=2 V57=2 V58=2 V60=2 V61=2 V62=2 V63=2 V64=2 V65=2 V66=2 V67=2 V68=2 V69=2 V70=2 V71=2 V72=2 V73=2 V74=2 V75=2 V76=2 V77=2 V78=2 V79=2 V80=2 V81=2 V82=2 V83=2 V84=2 V85=2 V87=2 V88=2 V89=2 V90=2 V92=2 V93=2 V94=2 V95=2 V96=2 V97=2 V98=2 V99=2 V100=2 V102=2 V103=2 V104=2 V105=2 V106=2 V107=2 V108=2 V109=2 V110=2 V111=2 V112=2 V113=2 V114=2 V115=2 V118=2 V119=2 V120=2 V121=2 V122=2 V123=2 V124=2 V125=2 V126=2 V127=2 V128=2 V129=2 V130=2 V131=2 V132=2 V133=2 V134=2 V135=2 V136=2 V137=2 V138=2 V139=2 V140=2 V141=2 V142=2 V143=2 MV15=3 MV21=5 MV35=3 MV45=5 MV59=3 MV86=5 MV91=3 MV101=3 MV116=3 MV117=3
;; 
;; 
(set-logic QF_BV)
(declare-fun benchmark_29 () Bool)
(declare-fun V0 () Bool)
(declare-fun V1 () Bool)
(declare-fun V2 () Bool)
(declare-fun V3 () Bool)
...
(declare-fun MV45 () (_ BitVec 3))
(assert (and (bvuge MV45 (_ bv0 3)) (bvult MV45 (_ bv5 3))))
(declare-fun MV45_0 () (_ Bool))
(declare-fun MV45_1 () (_ Bool))
(declare-fun MV45_2 () (_ Bool))
...
(declare-fun MV91 () (_ BitVec 2))
(assert (and (bvuge MV91 (_ bv0 2)) (bvult MV91 (_ bv3 2))))
(declare-fun MV91_0 () (_ Bool))
(declare-fun MV91_1 () (_ Bool))
(declare-fun MV101 () (_ BitVec 2))
(assert (and (bvuge MV101 (_ bv0 2)) (bvult MV101 (_ bv3 2))))
(declare-fun MV101_0 () (_ Bool))
(declare-fun MV101_1 () (_ Bool))
(declare-fun MV116 () (_ BitVec 2))
(assert (and (bvuge MV116 (_ bv0 2)) (bvult MV116 (_ bv3 2))))
(declare-fun MV116_0 () (_ Bool))
(declare-fun MV116_1 () (_ Bool))
(declare-fun MV117 () (_ BitVec 2))
(assert (and (bvuge MV117 (_ bv0 2)) (bvult MV117 (_ bv3 2))))
(declare-fun MV117_0 () (_ Bool))
(declare-fun MV117_1 () (_ Bool))
(assert benchmark_29)
(assert (or (not V14) V19))
(assert (or (not V5) V11))
(assert (or V13 (not V23)))
(assert (or V27 (not V28)))
(assert (or (not V25) V26))
(assert (or (not V0) V6))
(assert (or (not V1) V8))
(assert (or (not V8) (not V22)))
(assert (or (not V11) (not (= MV21 (_ bv1 3)))))
(assert (or V3 (not V9)))
(assert (or V22 (not V28)))
(assert (or (not V16) V27))
(assert (or V2 (not V7)))
(assert (or V4 V10))
(assert (or (not V3) V22))
(assert (or V20 V24))
(assert (or (not V4) (not (= MV15 (_ bv2 2)))))
(assert (or (not (= MV15 (_ bv0 2))) V19))
(assert (or V0 (not V13)))
(assert (or V2 (or V17 V28)))
(assert (or V12 (or V22 (not V26))))
(assert (or V1 (or V18 V19)))
...
(assert (= MV45_0 (= (bvand MV45 (_ bv1 3)  ) (_ bv1 3))))
(assert (= MV45_1 (= (bvand MV45 (_ bv2 3)  ) (_ bv2 3))))
(assert (= MV45_2 (= (bvand MV45 (_ bv4 3)  ) (_ bv4 3))))
...
(assert (= MV91_0 (= (bvand MV91 (_ bv1 2)  ) (_ bv1 2))))
(assert (= MV91_1 (= (bvand MV91 (_ bv2 2)  ) (_ bv2 2))))
(assert (= MV101_0 (= (bvand MV101 (_ bv1 2)  ) (_ bv1 2))))
(assert (= MV101_1 (= (bvand MV101 (_ bv2 2)  ) (_ bv2 2))))
(assert (= MV116_0 (= (bvand MV116 (_ bv1 2)  ) (_ bv1 2))))
(assert (= MV116_1 (= (bvand MV116 (_ bv2 2)  ) (_ bv2 2))))
(assert (= MV117_0 (= (bvand MV117 (_ bv1 2)  ) (_ bv1 2))))
(assert (= MV117_1 (= (bvand MV117 (_ bv2 2)  ) (_ bv2 2))))
